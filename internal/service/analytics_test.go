...
func (a *analyticsRepoFake) CreateUnsubscribe(_ context.Context, _ string, _ string) error {
	return nil
}
...
func (a *analyticsRepoFake) DeleteUnsubscribe(_ context.Context, _ string, _ uuid.UUID) error {
	return nil
}
